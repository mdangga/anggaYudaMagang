...
================================ */
const form = useForm({
    name_department: props.department.name_department,
    degree_level: props.department.degree_level,
    id_faculty: props.department.id_faculty,
    errors: {}
})
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">Edit Jurusan</h1>
                        <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
                            Edit jurusan yyang sudah ada pada sistem.
                        </p>
                    </div>
                </div>
            </div>
